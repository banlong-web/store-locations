...
if (!class_exists('STL_WOO_PLUGIN_Public_Public')) {
    class STL_WOO_PLUGIN_Public_Public
    {
        ...
        {
            add_action('woocommerce_product_meta_end', array($this, 'custom_woocommerce_product_meta_end'));
            ...
            if ($terms) { ?>
                <div class="ui container">
                    ...
                    <div class="content-select">
                        <select class="search tax_location_select" name="select_location" data-product_id="<?php echo esc_attr($product_id); ?>">
